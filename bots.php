...
if($rand_bot_number > $rand_bot_win_num) {
  ...
  $bot = "INSERT INTO `kot_games` (`game`, `user_id`, `login`, `number`, `cel`, `sum`, `chance`, `type`, `win_summa`) VALUES ('DICE', '1', '$logbot', '$rand_bot_number', '$rand_bot_cel', '$rand_bot_bet', '$rand_bot_per', '$rand_bot_type_game', '$rand_bot_sum');";
  mysql_query($bot);
  }
...
if($game == 2){
	...
	$bot = "INSERT INTO `kot_games` (`game`, `user_id`, `login`, `number`, `cel`, `sum`, `chance`, `type`, `win_summa`) VALUES ('MINES', '1', '$logbot', '$rand_bot_number', '$rand_bot_cel', '$rand_bot_bet', '$rand_bot_per', 'win', '$rand_bot_sum');";
  mysql_query($bot);
        }else{
            $rand_bot_sum = 0;
           $bot = "INSERT INTO `kot_games` (`game`, `user_id`, `login`, `number`, `cel`, `sum`, `chance`, `type`, `win_summa`) VALUES ('MINES', '1', '$logbot', '$rand_bot_number', '$rand_bot_cel', '$rand_bot_bet', '$rand_bot_per', 'lose', '$rand_bot_sum');";
  mysql_query($bot); 
        
        }
}
if($game == 3){
    $ww = [1.2,1.5,2,3,5,49.5];
    $r = rand(1,3);
    $win = $ww[$r];
    $w = rand(1,2);
     $rand_bot_bet = rand($bot_min, $bot_max); // ставка бота
    if ($w == 1){
        $bot = "INSERT INTO `kot_games` (`game`, `user_id`, `login`, `number`, `cel`, `sum`, `chance`, `type`, `win_summa`) VALUES ('WHEEL', '1', '$logbot', '$rand_bot_number', '$rand_bot_cel', '$rand_bot_bet', '$rand_bot_per', 'lose', '0');";
  mysql_query($bot); 
        
    }else{
        $rand_bot_sum = $win * $rand_bot_bet; 
        $bot = "INSERT INTO `kot_games` (`game`, `user_id`, `login`, `number`, `cel`, `sum`, `chance`, `type`, `win_summa`) VALUES ('WHEEL', '1', '$logbot', '$rand_bot_number', '$rand_bot_cel', '$rand_bot_bet', '$rand_bot_per', 'win', '$rand_bot_sum');";
  mysql_query($bot);
    }
}
...
if($game == 4){
    ...
    if ($kolvo == 0){
        $bot = "INSERT INTO `kot_games` (`game`, `user_id`, `login`, `number`, `cel`, `sum`, `chance`, `type`, `win_summa`) VALUES ('BUBBLES', '1', '$logbot', '$rand_bot_number', '$rand_bot_cel', '$rand_bot_bet', '$rand_bot_per', 'lose', '0');";
  mysql_query($bot); 
    }else{
    $bot = "INSERT INTO `kot_games` (`game`, `user_id`, `login`, `number`, `cel`, `sum`, `chance`, `type`, `win_summa`) VALUES ('BUBBLES', '1', '$logbot', '$rand_bot_number', '$rand_bot_cel', '$rand_bot_bet', '$rand_bot_per', 'win', '$rand_bot_sum');";
  mysql_query($bot);
    }
}
